...
@ShouldGenerate('''
  Future<User> _getUser() async {
    ...
    return onError != null ? Future.value(_value).catchError(onError) : Future.value(_value);
  }
''', contains: true)
@RestApi()
...
@ShouldGenerate('''
    ...
    final httpResponse = HttpResponse(_value, _result);
    return onError != null ? Future.value(httpResponse).catchError(onError) : Future.value(httpResponse);
''', contains: true)
@RestApi()
...
@ShouldGenerate(
  '''
  _TestOnErrorConstructor(this._dio, {this.baseUrl, this.errorLogger, this.onError});
  ''',
  contains: true,
)
@RestApi()
